...
Commandeck itself is **proprietary software**. The free desktop edition is covered
by its End User License Agreement (`LICENSE`); Commandeck Pro and the Android app
are covered by the paid EULA (`LICENSE-PRO`). See <https://commandeck.app/legal/terms/>.
