...
| Custom buttons | Up to 10 | Unlimited |
...
A yearly license expires 365 days after activation. Commandeck shows a warning toast 30 days before expiry.
...
- **Buttons & Settings backup** — exports buttons and preferences to a `.cdbackup` file
