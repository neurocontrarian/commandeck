...
After [installing Commandeck](installation.md), launch it — open **Commandeck** from your
applications menu (or run the AppImage you downloaded). Running from source instead?
...
![Commandeck main window with default buttons](assets/quick-start-grid.png)
...
!!! tip
    The free tier includes **unlimited local buttons**. [Commandeck Pro](pro.md) adds SSH machines, themes and AI.
...
| See real-world examples | [Use Cases](use-cases/index.md) |
