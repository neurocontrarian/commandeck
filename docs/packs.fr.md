...
![La galerie de packs de boutons — parcourir, prévisualiser et installer des packs](assets/packs-gallery.png)
...
- **Gratuit pour tout le monde** — installez-en autant que vous voulez, sur ordinateur (Linux,
  macOS, Windows) *et* sur Android quand l'app mobile sortira (bientôt disponible).
...
Sur votre ordinateur dès aujourd'hui — Linux, macOS et Windows. L'app Android arrive bientôt,
avec la même galerie : vous installerez aussi vos packs sur votre téléphone.
