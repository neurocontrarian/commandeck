...
**Gratuit vs Pro**
: La version **Gratuite** exécute des commandes locales illimitées avec jusqu'à 10 boutons personnalisés. **Pro** ajoute les machines SSH, les boutons multi-machines, les thèmes, les profils, la sauvegarde et l'intégration IA — avec un essai gratuit de 14 jours.
