...
This guide walks through setting up Commandeck to manage a typical home server — a machine running Plex, Pi-hole, or acting as a NAS. The goal: common maintenance tasks reduced to a single click.

!!! tip "Pro feature"
    This guide controls a remote machine over SSH. **SSH machines, multi-machine buttons, and execution profiles require [Commandeck Pro](../pro.md).** On the free tier you can still build the same buttons to run on your local computer.
...
!!! tip "Pro feature"
    Adding SSH machines requires [Commandeck Pro](../pro.md).

---

## Step 2 — Create a "Home Server" category

In the Button Editor, every button you create for this server will use **Category: Home Server**. This groups them under a dedicated entry in the category dropdown.
...
Selecting your **Home Server** category from the header dropdown gives you one-click access to everything you need. No terminal required.

!!! tip
    If you manage the server frequently throughout the day, enable **Always on top** in the hamburger menu. Commandeck stays visible while you work in other applications.

---

## Quick how-tos

Single-task shortcuts for the most common jobs:

- [Restart Jellyfin or Plex Without the Terminal](../how-to/restart-jellyfin-plex-without-terminal.md)
- [Manage Your Home Server From Windows](../how-to/manage-home-server-from-windows.md)
- [Run Docker Commands as One-Click Buttons](../how-to/docker-commands-one-click-buttons.md)
- [Check Disk Space on Your NAS in One Click](../how-to/check-disk-space-nas.md)
- [Update Your Server Without SSH-ing In](../how-to/update-server-without-ssh.md)
