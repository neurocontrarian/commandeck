...
Ce guide montre comment utiliser Commandeck comme palette de commandes pour développeur. L'objectif : remplacer les commandes de terminal les plus répétitives par des boutons en un clic, organisés par projet.

!!! tip "Fonctionnalité Pro"
    Ce workflow exécute des commandes sur un VPS distant en SSH. **Les machines SSH, les boutons multi-machines et les profils d'exécution nécessitent [Commandeck Pro](../pro.fr.md).** Les boutons purement locaux de ce guide fonctionnent dans la version gratuite.
...
Vous exécutez les mêmes commandes des dizaines de fois par jour : build, test, déploiement, consultation des logs. Commandeck remplace vos réflexes musculaires par des boutons visibles et étiquetés.
...
1. **Ctrl+clic** sur chaque bouton Backend (ou faites un rubber-band pour tous les sélectionner) — la barre d'actions apparaît en bas
2. Cliquez sur **Machine** dans la barre d'actions
...
Deux catégories nettes — Frontend et Backend — dans le menu déroulant de l'en-tête font apparaître exactement les commandes dont vous avez besoin. Votre terminal reste ouvert pour le travail exploratoire ; Commandeck gère les parties répétitives.
