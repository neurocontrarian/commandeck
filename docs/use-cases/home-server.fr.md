...
Ce guide explique comment configurer Commandeck pour gérer un serveur domestique typique — une machine exécutant Plex, Pi-hole ou servant de NAS. L'objectif : réduire les tâches de maintenance courantes à un simple clic.

!!! tip "Fonctionnalité Pro"
    Ce guide pilote une machine distante en SSH. **Les machines SSH, les boutons multi-machines et les profils d'exécution nécessitent [Commandeck Pro](../pro.fr.md).** Dans la version gratuite, vous pouvez créer les mêmes boutons pour une exécution sur votre ordinateur local.
...
!!! tip "Fonctionnalité Pro"
    L'ajout de machines SSH nécessite [Commandeck Pro](../pro.md).

---

## Étape 2 — Créer une catégorie "Serveur Maison"

Dans l'éditeur de bouton, chaque bouton que vous créez pour ce serveur utilisera **Catégorie : Serveur Maison**. Cela les regroupe sous une entrée dédiée du menu déroulant de catégories.
...
Votre catégorie **Serveur Maison** (dans le menu déroulant de l'en-tête) vous donne accès en un clic à tout ce dont vous avez besoin. Sans terminal.

!!! tip
    Si vous gérez fréquemment le serveur tout au long de la journée, activez **Toujours au premier plan** dans le menu hamburger. Commandeck reste visible pendant que vous travaillez dans d'autres applications.

---

## Tutoriels rapides

Raccourcis par tâche pour les besoins les plus fréquents :

- [Redémarrer Jellyfin ou Plex sans terminal](../how-to/restart-jellyfin-plex-without-terminal.md)
- [Gérer son serveur maison depuis Windows](../how-to/manage-home-server-from-windows.md)
- [Commandes Docker en boutons d'un clic](../how-to/docker-commands-one-click-buttons.md)
- [Voir l'espace disque de son NAS en un clic](../how-to/check-disk-space-nas.md)
- [Mettre à jour son serveur sans SSH](../how-to/update-server-without-ssh.md)
