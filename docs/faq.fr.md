...
thèmes, la sauvegarde/restauration et le serveur MCP.
Chaque version Pro inclut un **essai automatique de 14 jours** — sans carte, sans email.
Voir [Pro & tarifs](pro.fr.md).

## J'ai acheté Pro — comment l'activer ?

Gratuit et Pro sont **deux téléchargements séparés**. Votre clé de licence s'active dans la
version **Pro** : [téléchargez-la](download.fr.md), ouvrez les **Préférences**, cliquez
**Activer Pro** et collez votre clé. Si vous utilisiez la version gratuite, pas d'inquiétude —
les deux versions partagent la même configuration : **vos boutons et réglages sont conservés**
automatiquement.
...
boutons s'éditent dans l'interface et sont stockés en TOML lisible sur votre disque.
Plusieurs personnes peuvent très bien agir sur le même serveur : chacune installe
Commandeck sur son propre appareil et garde ses boutons pour cette machine — sous le même
toit, tout le monde peut ainsi piloter le serveur familial. La seule vraie différence, c'est
où vivent les boutons : sur l'ordinateur ou le téléphone de chacun, et non sur un serveur
central qu'il faut installer puis entretenir.

## Est-ce qu'il envoie des données vers l'extérieur ? Télémétrie ? Compte ?
...
et le partage de boutons utiles. Chaque signalement est lu, et les bogues sont corrigés.
