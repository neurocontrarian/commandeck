...
Le cœur est **gratuit et open source (AGPLv3)** : commandes et boutons locaux illimités,
sans compte, sans expiration. **Pro** est un **achat unique de 29 $** (pas d'abonnement ;
1 an de mises à jour inclus) qui ajoute les machines SSH, les boutons multi-machines, les
...
Votre config est du TOML en clair sur votre disque, et le cœur est en AGPLv3 : le code
source reste disponible.
