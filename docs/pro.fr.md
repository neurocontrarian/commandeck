...
Commandeck existe en deux versions : **Gratuite** (open source, exécution locale uniquement) et **Pro** (propriétaire, avec SSH et intégration IA).
...
| Boutons personnalisés | Jusqu'à 10 | Illimités |
...
Une licence annuelle expire 365 jours après l'activation. Commandeck affiche un avertissement 30 jours avant l'expiration.
...
- **Sauvegarde boutons & paramètres** — exporte les boutons et les préférences dans un fichier `.cdbackup`
