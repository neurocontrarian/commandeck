...
- L'achat est **un paiement unique — sans renouvellement automatique et sans rien à annuler**. Une fois acheté, l'application reste déverrouillée sur votre compte Google ; restaurez-la sur un nouvel appareil via **Restaurer les achats**. La facturation est également régie par les **conditions d'utilisation de Google Play**.
