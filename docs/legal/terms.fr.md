...
L'application **Android** est distribuée via le **Google Play Store** sous forme d'**abonnement** à renouvellement automatique, Google étant le vendeur et le prestataire de paiement (et non LemonSqueezy). Pour l'application Android, les éléments suivants s'appliquent à la place des dispositions sur les clés de licence des sections 2 à 5 :

- L'accès nécessite un **abonnement Google Play actif** lié à votre compte Google. Il n'y a **aucune version gratuite, aucune clé de licence ni limite d'appareils** sur mobile.
- L'abonnement **se renouvelle automatiquement** jusqu'à son annulation. Vous pouvez **l'annuler à tout moment** dans le Google Play Store pour arrêter les renouvellements futurs ; l'accès se poursuit jusqu'à la fin de la période de facturation en cours. Le renouvellement automatique, la facturation et l'annulation sont également régis par les **conditions d'utilisation de Google Play**.
- Le cœur open source de Commandeck reste sous licence **AGPLv3** (code source sur [github.com/neurocontrarian/commandeck](https://github.com/neurocontrarian/commandeck)) ; le nom **Commandeck** et les éléments de marque demeurent réservés.
...
**Version gratuite.** Le cœur open source de Commandeck est un logiciel libre sous **licence publique générale GNU Affero, version 3 (AGPLv3)**. Le code source est disponible sur [github.com/neurocontrarian/commandeck](https://github.com/neurocontrarian/commandeck). Vous pouvez l'utiliser, l'étudier, le modifier et le distribuer selon les termes de l'AGPLv3 ; si vous distribuez une version modifiée, ou exécutez une version modifiée comme service réseau, vous devez rendre vos modifications disponibles sous l'AGPLv3.

**Marques.** Aucune licence accordée ici, y compris l'AGPLv3, n'accorde de droit sur le nom **Commandeck**, le logo ou les autres marques ou éléments de marque de l'auteur, qui sont réservés. Vous ne pouvez pas les utiliser d'une manière qui sous-entendrait une approbation ou une affiliation sans autorisation.

**Fonctionnalités Pro.** Le module Pro (`commandeck_core/pro/`) est un logiciel propriétaire. L'achat d'une licence Pro vous accorde un droit d'utilisation personnel, non transférable et non exclusif des fonctionnalités Pro sur **3 appareils desktop simultanément** (Linux, macOS, Windows) que vous possédez ou contrôlez. L'application Android est un produit distinct distribué via le Google Play Store et n'est pas couvert par cette licence desktop.
...
Les titulaires de licence Pro bénéficient d'1 an de mises à jour à compter de la date d'achat. Passé ce délai, la version du Logiciel installée pendant cette période continue de fonctionner indéfiniment — les fonctionnalités Pro n'expirent pas pour la version installée. Les mises à jour ultérieures pourront nécessiter un renouvellement (tarif et modalités à annoncer).
