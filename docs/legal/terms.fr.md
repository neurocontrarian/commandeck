...
**Fonctionnalités Pro.** Le module Pro (`commandeck_core/pro/`) est un logiciel propriétaire. L'achat d'une licence Pro vous accorde un droit d'utilisation personnel, non transférable et non exclusif des fonctionnalités Pro sur **3 appareils simultanément** que vous possédez ou contrôlez.
...
- Utiliser les fonctionnalités Pro sur plus de 3 appareils simultanément
...
**Expiration de la licence annuelle.** Si une licence annuelle n'est pas renouvelée, les fonctionnalités Pro sont automatiquement désactivées à la fin de la période d'abonnement (avec un délai de grâce de 3 jours). Le Logiciel revient à la version gratuite : la gestion des machines SSH, les boutons personnalisés illimités et les autres fonctionnalités Pro ne sont plus accessibles. Les boutons personnalisés créés au-delà de la limite de la version gratuite (10) sont masqués mais non supprimés — ils sont entièrement restaurés lors du renouvellement. Vos données de configuration ne sont jamais supprimées en raison d'un abonnement expiré.
