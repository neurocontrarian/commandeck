...
Sur Android, l'abonnement est vendu et traité par **Google Play Billing**. Google est le
...
aucun compte, et ne transmet aucune donnée personnelle** — l'état de votre abonnement est fourni
...
- **Google Play Billing** — abonnement sur Android ; la politique de confidentialité de Google
  s'applique.
...
LemonSqueezy. Sur Android, votre abonnement se gère depuis votre compte Google Play.
