...
On Android, the subscription is sold and processed by **Google Play Billing**. Google is the
...
your subscription status is provided by Google Play on your device.
...
- **Google Play Billing** — Android subscription processing; Google's privacy policy applies.
...
the device activation record from LemonSqueezy's servers. On Android, your subscription is managed
