...
**Un'unica eccezione, una volta sola:** una licenza attivata con una versione precedente alla 2.4.4 deve essere confermata online la prima volta che apri la 2.4.4 o successiva. Apri Commandeck una volta con la connessione dopo l'aggiornamento; da lì in poi, offline funziona di nuovo.

### *La scheda Licenza dice «Questa è l'edizione gratuita di Commandeck»*

Stai usando la **versione gratuita**. Non contiene codice Pro, quindi una chiave di licenza lì non ha nulla da sbloccare. Clicca **Scarica Commandeck Pro** in quella scheda — ottieni la versione Pro più recente per il tuo sistema — e avvia quella. I tuoi pulsanti, le macchine e le impostazioni vengono ripresi automaticamente (stessa cartella di configurazione). **Informazioni**, nel menu ☰, indica anche quale edizione stai usando.

### *«La tua licenza deve essere riattivata su questo dispositivo»*

Commandeck non riconosce più l'attivazione di questo dispositivo. Succede quando:

- il file di licenza è stato **copiato da un altro computer** (una licenza è legata al dispositivo su cui è stata attivata),
- il sistema è stato **reinstallato**, o il computer sostituito,
- lo slot di questo dispositivo è stato **liberato** da un altro dispositivo, o LemonSqueezy non lo riconosce più.

La tua chiave è conservata e già compilata: clicca **Attiva Pro** con una connessione a internet. Su un nuovo dispositivo questo usa uno dei tuoi 3 slot — vedi [Licenza e dispositivi](license-devices.md).
