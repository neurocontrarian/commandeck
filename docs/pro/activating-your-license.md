...
**One exception, once:** a license activated with a version older than 2.4.4 must be confirmed online the first time you open 2.4.4 or later. Open Commandeck once while connected after updating; from then on, offline is fine again.

### *The License tab says "This is the free edition of Commandeck"*

You're running the **Free build**. It contains no Pro code, so a license key has nothing to unlock there. Click **Download Commandeck Pro** in that tab — it gets the newest Pro build for your system — and run it instead. Your buttons, machines and settings will be picked up automatically (same config directory). **About** in the ☰ menu also tells you which edition you're running.

### *"Your license needs re-activation on this device"*

Commandeck no longer recognises this device's activation. It happens when:

- the license file was **copied from another computer** (a license is tied to the device it was activated on),
- the operating system was **reinstalled**, or the computer replaced,
- this device's slot was **freed** from another device, or LemonSqueezy no longer knows it.

Your key is kept and already filled in: click **Activate Pro** while connected to the internet. On a new device this uses one of your 3 slots — see [License & Devices](license-devices.md).
...
- **[Refund policy](../legal/refund.md)** — the 14-day guarantee, and what it covers
