...
6. Importez le fichier `.cdvariables` pour restaurer vos valeurs de variables enregistrées
7. Testez chaque connexion machine depuis **Menu → Gérer les machines → (sélectionner la machine) → Tester**
