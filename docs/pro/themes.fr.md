...
La couleur de chaque bouton sur fond noir : bordure et halo lumineux dans la couleur du bouton, texte cyan. S'illumine au survol. Idéal pour le mode sombre.

![Thème Neon](../assets/theme-neon.png)

!!! note
    Le halo de Neon s'apprécie mieux en utilisation — survoler un bouton avive sa bordure.
