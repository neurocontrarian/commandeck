...
Each button's own color on black: a glowing border and halo in the button's color, with cyan text. Brightens on hover. Dark-mode friendly.

![Neon theme](../assets/theme-neon.png)

!!! note
    Neon's halo is best appreciated at runtime — hovering a button brightens its border.
