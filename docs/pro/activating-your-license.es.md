...
**Una única excepción, una sola vez:** una licencia activada con una versión anterior a la 2.4.4 debe confirmarse en línea la primera vez que abras la 2.4.4 o posterior. Abre Commandeck una vez con conexión después de actualizar; a partir de ahí, sin conexión vuelve a funcionar.

### *La pestaña Licencia dice «Esta es la edición gratuita de Commandeck»*

Estás usando la **versión gratuita**. No contiene código Pro, así que una clave de licencia no tiene nada que desbloquear ahí. Pulsa **Descargar Commandeck Pro** en esa pestaña —obtienes la versión Pro más reciente para tu sistema— y ábrela en su lugar. Tus botones, máquinas y ajustes se recogen automáticamente (misma carpeta de configuración). **Acerca de**, en el menú ☰, también indica qué edición usas.

### *«Tu licencia necesita reactivarse en este dispositivo»*

Commandeck ya no reconoce la activación de este dispositivo. Ocurre cuando:

- el archivo de licencia se **copió desde otro ordenador** (una licencia está ligada al dispositivo donde se activó),
- el sistema se **reinstaló** o se cambió de ordenador,
- el hueco de este dispositivo se **liberó** desde otro dispositivo, o LemonSqueezy ya no lo reconoce.

Tu clave se conserva y ya está rellenada: pulsa **Activar Pro** con conexión a internet. En un dispositivo nuevo esto usa uno de tus 3 huecos; consulta [Licencia y dispositivos](license-devices.md).
