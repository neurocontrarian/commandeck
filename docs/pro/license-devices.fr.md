...
!!! tip "Pro"
    Une clé de licence est nécessaire pour activer [Commandeck Pro](../pro.md).

Chaque clé de licence autorise **3 activations simultanées sur des appareils desktop** (Linux, macOS, Windows) que vous possédez ou contrôlez personnellement.

!!! note "Desktop uniquement — Android est un produit séparé"
    Cette licence couvre l'**application desktop** (Linux, macOS, Windows). L'application Android est un produit distinct sur Google Play avec sa propre facturation ; elle ne s'active pas avec une clé de licence desktop et ne consomme pas d'emplacements ici.
...
2. Configurez le nouvel appareil et installez Commandeck
...
1. Ouvrez Commandeck sur un autre appareil encore activé et désactivez via **Préférences → Licence → Désactiver** pour libérer un slot, puis réessayez
...
Ouvrez Commandeck sur l'un de vos 3 appareils actifs, allez dans **Préférences → Licence → Désactiver**, puis activez sur le nouvel appareil.

!!! note
    Le portail client LemonSqueezy ne permet **pas** de désactiver soi-même ses instances. Pour libérer un slot, utilisez le bouton **Désactiver** dans Commandeck sur l'un de vos appareils actifs.

---

## Politique de partage de clé

Chaque clé de licence est personnelle et non transférable. Lors de l'activation, Commandeck vérifie que l'adresse e-mail saisie correspond à celle de l'achat. Les clés détectées sur plus de 3 appareils simultanément seront révoquées sans remboursement.
