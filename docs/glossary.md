...
**Free vs Pro**
: The **Free** tier runs unlimited local commands with up to 10 custom buttons. **Pro** adds SSH machines, multi-machine buttons, themes, profiles, backup, and AI integration — with a 14-day free trial.
