...
!!! note "Free edition"
    In the free edition this tab explains that Pro is a separate download with a 14-day trial, and offers **Download Commandeck Pro** (the newest Pro build for your system) and a button to buy a license. A key can only be activated in the Pro edition.
