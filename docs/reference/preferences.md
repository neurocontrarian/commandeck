...
- **License type** — Yearly
- **Expiry date** — when the yearly license expires
...
Your buttons and machines are not deleted — custom buttons beyond 10 are temporarily hidden until you reactivate.
