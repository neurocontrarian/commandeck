...
- **Nada de telemetría, nunca.** La aplicación no tiene analíticas ni cuentas, y no envía ninguno de tus datos a ninguna parte: lo que pasa en tu máquina se queda en tu máquina. (El sitio web cuenta los clics en sus botones de descarga, sin cookies; consulta la [política de privacidad](../legal/privacy.md).)
