...
Assigns a saved [execution profile](execution-profiles.md) to this button. A profile bundles a target user, a working directory, and a sudo password into a single reusable entry.
