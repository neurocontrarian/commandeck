...
- **Aucune télémétrie.** L'application n'a ni statistiques ni comptes et n'envoie aucune de vos données vers l'extérieur : ce qui se passe sur votre machine y reste. (Le site web compte les clics sur ses boutons de téléchargement, sans cookie ; voir la [politique de confidentialité](../legal/privacy.md).)
