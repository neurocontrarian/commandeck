...
- **Le code est ouvert à qui veut le lire.** Le code source de la version gratuite est public : toute personne curieuse — ou prudente — peut vérifier exactement ce que fait l'application sur son ordinateur.
