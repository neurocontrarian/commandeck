...
- **No telemetry, ever.** The app has no analytics and no accounts, and it never sends any of your data anywhere — what happens on your machine stays on your machine. (The website counts clicks on its download buttons, without cookies; see the [privacy policy](../legal/privacy.md).)
