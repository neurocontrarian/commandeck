...
- **Type de licence** — Annuelle
- **Date d'expiration** — quand la licence annuelle expire
...
Vos boutons et machines ne sont pas supprimés — les boutons personnalisés au-delà de 10 sont temporairement masqués jusqu'à la réactivation.
