...
!!! note "Édition gratuite"
    Dans l'édition gratuite, cet onglet explique que Pro est un téléchargement séparé avec 14 jours d'essai, et propose **Télécharger Commandeck Pro** (la dernière version Pro pour votre système) ainsi qu'un bouton pour acheter une licence. Une clé ne peut être activée que dans l'édition Pro.
