...
- **Nessuna telemetria, mai.** L'app non ha statistiche né account, e non manda i tuoi dati da nessuna parte: ciò che accade sulla tua macchina resta sulla tua macchina. (Il sito web conta i clic sui suoi pulsanti di download, senza cookie; vedi l'[informativa sulla privacy](../legal/privacy.md).)
