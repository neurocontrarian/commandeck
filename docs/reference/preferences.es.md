...
!!! note "Edición gratuita"
    En la edición gratuita, esta pestaña explica que Pro es una descarga aparte con 14 días de prueba, y ofrece **Descargar Commandeck Pro** (la versión Pro más reciente para tu sistema) y un botón para comprar una licencia. Una clave solo se puede activar en la edición Pro.
