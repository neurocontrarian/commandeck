...
!!! note
    Custom buttons are unlimited on every tier. [Commandeck Pro](../pro.md) adds SSH machines, themes and AI integration.
...
!!! note
    Default buttons are fully editable by everyone — rename them, recolor them, change their command or delete them, on the free tier too.
...
![Output dialog showing the result of a command](../assets/output-dialog.png)
