...
!!! note
    Les boutons par défaut sont entièrement modifiables par tout le monde — renommez-les, recolorez-les, changez leur commande ou supprimez-les, y compris dans la version gratuite.
...
![Fenêtre de sortie affichant le résultat d'une commande](../assets/output-dialog.png)
