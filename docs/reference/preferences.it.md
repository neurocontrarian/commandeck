...
!!! note "Edizione gratuita"
    Nell'edizione gratuita questa scheda spiega che Pro è un download separato con 14 giorni di prova, e offre **Scarica Commandeck Pro** (la versione Pro più recente per il tuo sistema) e un pulsante per acquistare una licenza. Una chiave si può attivare solo nell'edizione Pro.
